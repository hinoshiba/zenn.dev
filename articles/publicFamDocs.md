...
家電量販店で物品を購入する際、宅内ドキュメントをさっと確認し型番を確認することができたりと、まとめておく癖がついていると、ふとしたときに恩恵を受けられます。  
...
というのも`普通`について、どうせみんな知っているので、わざわざ説明する必要がないと判断されがちな為です。    
しかし、`広く通用する`は、TPOによって異なるので、状況に応じて説明が必要なケースもありえます。  
説明すべきときにも説明されない`普通`とは、とても危険だと思いませんか。  
