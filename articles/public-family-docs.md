...
https://github.com/hinoshiba/public_iCH1family
情報量はまだ少なく、レイアウトも改善の余地ありですが、今後は、publicとして、宅内手順を更新していこうと思います。  

起因となった弊家の`普通`については、以下にまとめています。  
https://github.com/hinoshiba/public_iCH1family/blob/master/rule/friend2house.md
...
2025/01/31 追記  
GitHub運用は終了し、Notionへ移行したため、ドキュメントリンクはアーカイブずみリポジトリへ差し替えました。  
